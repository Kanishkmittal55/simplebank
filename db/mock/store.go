...
// Source: github.com/kanishkmittal55/simplebank/db/sqlc (interfaces: Store)
...
// GetRandomAccountId mocks base method.
func (m *MockStore) GetRandomAccountId(arg0 context.Context) (int64, error) {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "GetRandomAccountId", arg0)
	ret0, _ := ret[0].(int64)
	ret1, _ := ret[1].(error)
	return ret0, ret1
}

// GetRandomAccountId indicates an expected call of GetRandomAccountId.
func (mr *MockStoreMockRecorder) GetRandomAccountId(arg0 interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "GetRandomAccountId", reflect.TypeOf((*MockStore)(nil).GetRandomAccountId), arg0)
}
...
func (mr *MockStoreMockRecorder) InvalidateSession(arg0, arg1 interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
